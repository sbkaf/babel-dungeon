...
export const translations = {
  ...
  "lvl.{{l}}": undefined,
  NEW: "NEU",
  "Did you know it?": "Wusstest Du es?",
  Reveal: "Aufdecken",

  CREDITS: "DANKSAGUNG",
  "Developer: Asiel Diaz Benitez": "Entwickler: Asiel Diaz Benitez",
  "Sentences collection: tatoeba.org": "Sätze: tatoeba.org",
  'Music: "Cave" by celestialghost8': 'Musik: "Cave" by celestialghost8',
  "Sound effects by celestialghost8, Fupi and Dizzy Crow":
    "Soundeffekte von celestialghost8, Fupi and Dizzy Crow",
  "Translation: sbkaf": "Übersetzung: sbkaf",
  "More details at: github.com/ArcaneCircle/babel-dungeon":
    "Mehr Details unter: github.com/ArcaneCircle/babel-dungeon",
  ...
  "Can't import backup, it is not compatible with your version of the game":
    "Backup kann nicht importiert werden. Es ist nicht kompatibel mit Deiner Version des Spiels",
};
